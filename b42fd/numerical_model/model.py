...
def get_state_space(t):
    ...
    #weight in N
    hp0, V0, alpha0, weight, mub, muc, CL, CD, CX0, CZ0 = a.altitude, a.true_airspeed, a.angle_of_attack, a.weight, a.mub, a.muc, a.CL, a.CD, a.CX0, a.CZ0
    ...
    # return control.StateSpace(A_s_h, B_s_h, C_s_h, D_s_h), control.StateSpace(A_a_h, B_a_h, C_a_h, D_a_h), A_s_h, A_a_h
    return A_s_h, B_s_h, C_s_h, D_s_h, A_a_h, B_a_h, C_a_h, D_a_h
